...
var SKILLS_DATA = {
	...
	"BARRERA DE VIENTO": { "id": "SK-DEF-05", "type": "Defensa", "desc": "Crea una barrera de viento que repele a los objetivos seleccionados.", "duration": 6, "width": 150, "cd": 20000.0, "range": 400, "canTargetOthers": false, "targetFilters": { "allies": false, "enemies": true, "bosses": false, "players": false }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
