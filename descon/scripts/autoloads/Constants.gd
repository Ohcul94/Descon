...
var SKILLS_DATA = {
	...
	"BLINK": { "id": "SK-UTIL-04", "type": "Utilidad", "desc": "Teletransportación instantánea al punto seleccionado.", "range": 450, "cd": 15000.0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
