...
var SKILLS_DATA = {
	"ESCUDO CELULAR": { "id": "SK-DEF-01", "type": "Defensa", "desc": "Inyecta plasma en los generadores para restaurar el escudo.", "amount": 600, "cd": 5000.0, "range": 0, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	...
	"REFLECT-OMEGA": { "id": "SK-ATK-01", "type": "Ataque", "desc": "Crea un campo de resonancia que refleja daño hostil.", "reflect_mult": 1.5, "amount": 500, "cd": 5000.0, "range": 500, "duration": 3000, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
