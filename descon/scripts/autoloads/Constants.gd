...
var MECHANICS_LIB: Dictionary = {}
var MOVEMENT_LIB: Dictionary = {}
var DEFENSE_LIB: Dictionary = {}
...
func _on_config_updated(config):
	...
	if config.has("mechanicsLib"): MECHANICS_LIB = config.mechanicsLib
	if config.has("movementLib"): MOVEMENT_LIB = config.movementLib
	if config.has("defenseLib"): DEFENSE_LIB = config.defenseLib
...
var SKILLS_DATA = {
	"ESCUDO CELULAR": { "id": "SK-DEF-01", "type": "Defensa", "aimType": 1, "desc": "Inyecta plasma en los generadores para restaurar el escudo.", "amount": 600, "cd": 5000.0, "range": 500, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"AUTO-REPARACIÓN": { "id": "SK-HEAL-01", "type": "Curación", "desc": "Drones de reparación restauran la integridad del casco.", "amount": 400, "cd": 5000.0, "range": 500, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"NANO-REGENERACIÓN": { "id": "SK-HEAL-02", "type": "Curación", "desc": "Inyecta nanobots que reparan el casco de forma continua.", "amount": 300, "cd": 12000.0, "range": 0, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"REGENERACIÓN ALFA": { "id": "SK-HEAL-03", "type": "Curación", "desc": "Un pulso de alta energía que deposita un núcleo en el suelo para restaurar 1500 HP de casco al recogerlo.", "amount": 1500, "cd": 20000.0, "range": 600, "duration": 60000.0, "radius": 100.0, "canTargetOthers": false, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"VÍNCULO VITAL": { "id": "SK-HEAL-04", "type": "Curación", "desc": "Enlaza un rayo curativo continuo a un aliado que restaura HP periódicamente. El lazo se corta si se alejan demasiado.", "amount": 250, "cd": 15000.0, "range": 350, "duration": 10000.0, "breakRange": 500.0, "tickInterval": 1000.0, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"TURBO-IMPULSO": { "id": "SK-UTIL-01", "type": "Utilidad", "desc": "Aumenta la velocidad de los motores temporalmente.", "speed": 150, "cd": 5000.0, "range": 0, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"HYPER-DASH": { "id": "SK-UTIL-02", "type": "Utilidad", "desc": "Propulsión instantánea hacia adelante para evasión rápida.", "speed": 1000, "duration": 500, "cd": 5000.0, "range": 0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"INVULNERABILIDAD": { "id": "SK-UTIL-03", "type": "Utilidad", "desc": "Te vuelve inmune a todo daño durante 2 segundos.", "duration": 2.0, "cd": 30000.0, "range": 0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"BLINK": { "id": "SK-UTIL-04", "type": "Utilidad", "aimType": 0, "desc": "Teletransportación instantánea al punto seleccionado.", "range": 450, "cd": 15000.0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"REFLECT-OMEGA": { "id": "SK-ATK-01", "type": "Ataque", "aimType": 1, "desc": "Crea un campo de resonancia que refleja daño hostil.", "reflect_mult": 1.5, "amount": 500, "cd": 5000.0, "range": 500, "duration": 3000, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"REFLECT": { "id": "SK-ATK-01", "type": "Ataque", "aimType": 1, "desc": "Crea un campo de resonancia que refleja daño hostil.", "reflect_mult": 1.5, "amount": 500, "cd": 5000.0, "range": 500, "duration": 3000, "canTargetOthers": true, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"ESFERA DE TERROR": { "id": "SK-ATK-02", "type": "Ataque", "desc": "Lanza una esfera de energía oscura que daña y aterroriza al objetivo.", "amount": 1, "duration": 1000, "cd": 10000.0, "range": 800, "radius": 150, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"SMOKE-BOMB": { "id": "SK-DEF-03", "type": "Defensa", "desc": "Lanza una bomba de humo que silencia y ciega a los enemigos en el área.", "duration": 6, "radius": 180, "cd": 12000.0, "range": 0, "amount": 1, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"STEALTH": { "id": "SK-UTIL-05", "type": "Utilidad", "desc": "Te vuelve invisible para enemigos y jugadores fuera de tu grupo.", "duration": 8, "cd": 25000.0, "range": 0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"FROST-TRAIL": { "id": "SK-DEF-04", "type": "Defensa", "desc": "Deja un rastro de escarcha que ralentiza a los enemigos.", "duration": 6, "slow_amount": 0.5, "radius": 120, "cd": 18000.0, "range": 0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"BARRERA DE VIENTO": { "id": "SK-DEF-05", "type": "Defensa", "desc": "Crea una barrera de viento que repele a los objetivos seleccionados.", "duration": 6, "width": 150, "cd": 20000.0, "range": 400, "canTargetOthers": false, "targetFilters": { "allies": false, "enemies": true, "bosses": false, "players": false, "blockProjectiles": false }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"BALIZA DE CURACION": { "id": "SK-HEAL-05", "type": "Curación", "aimType": 2, "desc": "Despliega una baliza que emite ondas de curación periódicas a los aliados cercanos.", "duration": 8000.0, "pulse_interval": 1500.0, "heal_amount": 250, "cd": 18000.0, "range": 500, "radius": 200.0, "canTargetOthers": false, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"PROVOCACION": { "id": "SK-DEF-06", "type": "Defensa", "desc": "Provoca a todos los enemigos en el área elegida, forzándolos a atacarte.", "taunt_duration": 4000.0, "cd": 15000.0, "range": 450, "radius": 220.0, "canTargetOthers": false, "targetFilters": { "allies": false, "enemies": true, "bosses": true, "players": false }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
	"RESURRECCIÓN": { "id": "SK-UTIL-06", "type": "Utilidad", "aimType": 2, "desc": "Canaliza un haz de energía en el área seleccionada para resucitar a los aliados caídos.", "cd": 45000.0, "range": 500, "radius": 200.0, "revive_hp_pct": 50, "revive_shield_pct": 20, "canTargetOthers": false, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true, "clan": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 }
}
