...
var SKILLS_DATA = {
	...
	"RESURRECCIÓN": { "id": "SK-UTIL-06", "type": "Utilidad", "desc": "Canaliza un haz de energía en el área seleccionada para resucitar a los aliados caídos.", "cd": 45000.0, "range": 500, "radius": 200.0, "revive_hp_pct": 50, "revive_shield_pct": 20, "canTargetOthers": false, "targetFilters": { "allies": true, "enemies": false, "bosses": false, "players": true, "clan": true }, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 }
}
