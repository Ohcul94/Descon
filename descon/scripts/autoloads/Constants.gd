...
var SKILLS_DATA = {
	...
	"REFLECT-OMEGA": { "id": "SK-ATK-01", "type": "Ataque", "desc": "Crea un campo de resonancia que refleja daño hostil.", "reflect_mult": 1.5, "amount": 500, "cd": 5000.0, "range": 0, "canTargetOthers": false, "sound": "", "soundVolumePercent": 50, "soundMaxDist": 1400 },
