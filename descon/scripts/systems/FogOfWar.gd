...
func _setup_post_process_quad():
	...
	shader_mat.set_shader_parameter("cloud_speed2", -0.010)
	shader_mat.set_shader_parameter("elevation_speed", 0.006)
	shader_mat.set_shader_parameter("cloud_contrast", 1.25)
	shader_mat.set_shader_parameter("noise_scale", 0.010)
	shader_mat.set_shader_parameter("noise_speed", 0.016)
