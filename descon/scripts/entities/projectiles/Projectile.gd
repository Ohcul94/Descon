...
const VFX_Siphon_projectile_scene = preload("res://VFX/scenes/VFX_Darkness_projectile.tscn")
const VFX_Siphon_Hit_scene = preload("res://VFX/scenes/VFX_Hit_dark.tscn")
