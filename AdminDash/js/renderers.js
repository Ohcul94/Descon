    ...
    config.shopItems.shields.forEach((s, i) => {
        ...
        card.innerHTML = `
            ...
            <div class="form-grid" style="margin-top:1rem;">
                ...
                <div class="field full"><label>Mod. Escudo</label><div style="display:flex;gap:6px;align-items:center;"><input type="number" value="${s.shieldMod || 0}" onchange="config.shopItems.shields[${i}].shieldMod = parseFloat(this.value)" style="flex:1;min-width:80px;"><select onchange="config.shopItems.shields[${i}].shieldModType = this.value" style="width:auto;min-width:55px;max-width:65px;font-size:0.65rem;background:#1a1a2e;color:#fff;border:1px solid rgba(255,255,255,0.15);border-radius:4px;padding:2px 4px;"><option value="percent" ${(s.shieldModType||'percent')==='percent'?'selected':''}>%</option><option value="flat" ${(s.shieldModType||'percent')==='flat'?'selected':''}>FIJO</option></select></div></div>
                <div class="field full"><label>Mod. Daño</label><div style="display:flex;gap:6px;align-items:center;"><input type="number" value="${s.dmgMod || 0}" onchange="config.shopItems.shields[${i}].dmgMod = parseFloat(this.value)" style="flex:1;min-width:80px;"><select onchange="config.shopItems.shields[${i}].dmgModType = this.value" style="width:auto;min-width:55px;max-width:65px;font-size:0.65rem;background:#1a1a2e;color:#fff;border:1px solid rgba(255,255,255,0.15);border-radius:4px;padding:2px 4px;"><option value="percent" ${(s.dmgModType||'percent')==='percent'?'selected':''}>%</option><option value="flat" ${(s.dmgModType||'percent')==='flat'?'selected':''}>FIJO</option></select></div></div>
    ...
    config.shopItems.engines.forEach((e, i) => {
        ...
        card.innerHTML = `
            ...
            <div class="form-grid" style="margin-top:1rem;">
                ...
                <div class="field full"><label>Mod. Velocidad</label><div style="display:flex;gap:6px;align-items:center;"><input type="number" value="${e.speedMod || 0}" onchange="config.shopItems.engines[${i}].speedMod = parseFloat(this.value)" style="flex:1;min-width:80px;"><select onchange="config.shopItems.engines[${i}].speedModType = this.value" style="width:auto;min-width:55px;max-width:65px;font-size:0.65rem;background:#1a1a2e;color:#fff;border:1px solid rgba(255,255,255,0.15);border-radius:4px;padding:2px 4px;"><option value="percent" ${(e.speedModType||'percent')==='percent'?'selected':''}>%</option><option value="flat" ${(e.speedModType||'percent')==='flat'?'selected':''}>FIJO</option></select></div></div>
