...
const DEFAULT_MECHANICS_LIB = {
    "laser": { label: "Láser Estándar", icon: "🔫", desc: "Ataque lineal básico.", fields: ["bulletDamage", "bulletSpeed", "fireRange", "fireRate", "burstShots", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "missile": { label: "Misil Rastreador", icon: "🚀", desc: "Proyectil autoguiado.", fields: ["bulletDamage", "bulletSpeed", "fireRange", "fireRate", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1500 },
    "ice_missile": { label: "Misil de Hielo", icon: "❄️", desc: "Ralentiza al objetivo.", fields: ["bulletDamage", "bulletSpeed", "fireRange", "fireRate", "slowAmount", "slowDuration", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1500 },
    "mine": { label: "Mina de Proximidad", icon: "💣", desc: "Explosivo estático.", fields: ["bulletDamage", "fireRange", "fireRate", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "orbital_strike": { label: "Ataque Orbital", icon: "🌀", desc: "Círculos que giran y luego se disparan.", fields: ["bulletDamage", "bulletSpeed", "orbitSpeed", "circleCount", "orbitRadius", "orbitDuration", "staticTime", "fireRate", "fireRange", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1400 },
    "aura_damage": { label: "Aura de Vacío (Daño)", icon: "🔥", desc: "Daña a los jugadores cercanos continuamente.", fields: ["activationHP", "radius", "damage", "intervalMs", "duration", "cooldown", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "hook": { label: "Gancho Abisal", icon: "⚓", desc: "Atrae al objetivo, lo daña y lo paraliza.", fields: ["bulletDamage", "bulletSpeed", "fireRange", "fireRate", "stunDuration", "pullSpeed", "postHookWaitMs", "hookMissWaitMs", "isHoming", "turnSpeed", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "cone_cast": { label: "Ataque en Cono Casteable", icon: "📐", desc: "Ataque en cono que se carga y al completarse daña/stunea.", fields: ["cooldown", "castTimeMs", "damage", "stunDuration", "castSpeed", "coneAngle", "fireRange", "coneFollow", "lockTimeMs", "aimDelayMs", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "bomb": { label: "Lanzador de Bombas", icon: "💣", desc: "Lanza bombas en círculo que explotan tras un retardo.", fields: ["bulletDamage", "radius", "fireRange", "bulletSpeed", "bombCount", "bombDelayMs", "fuseTimeMs", "cooldown", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "circle_cast": { label: "Explosión Circular", icon: "⭕", desc: "Ataque circular que se carga siguiendo al enemigo y explota dañando a todos.", fields: ["cooldown", "castTimeMs", "damage", "fireRange", "lockTimeMs", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    ...
    "survival_dome": { label: "Domo de Supervivencia (Survival Dome)", icon: "🔮", desc: "Carga un ataque masivo creando un domo seguro en una ubicacion aleatoria.", fields: ["fireRange", "safeRadius", "maxOffset", "castTimeMs", "cooldown", "damage", "postCastWaitMs", "startDelay", "debuffsList"], sound: "", soundVolumePercent: 50, soundMaxDist: 1500 },
    "ice_storm": { label: "Tormenta de Hielo", icon: "❄️", desc: "Invoca una tormenta de hielo persistente que daña y ralentiza a los jugadores en el área.", fields: ["cooldown", "castTimeMs", "fireRange", "radius", "lockTimeMs", "duration", "tick_interval", "damage_per_tick", "slow_amount", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1400 },
    "worm_boomerang": { label: "Gusanos Bumerán", icon: "🪱", desc: "Lanza un abanico de gusanos que se alejan, se detienen y regresan al origen dañando.", fields: ["projectileCount", "spreadAngle", "bulletSpeed", "fireRange", "parkTimeMs", "bulletDamage", "returnDamage", "debuffsList", "cooldown", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
...
const DEFAULT_DEFENSE_LIB = {
    "basic_defense": { label: "Defensa Estándar", icon: "🛡️", desc: "Mecánica de mitigación de daño y regeneración.", fields: ["reductionPercentage", "shieldRegen", "duration", "cooldown", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 800 },
    "aura_heal": { label: "Aura Curativa", icon: "✨", desc: "Cura a los aliados cercanos continuamente.", fields: ["activationHP", "radius", "healAmount", "intervalMs", "duration", "cooldown", "startDelay", "affectsEnemies", "affectsBosses"], sound: "", soundVolumePercent: 50, soundMaxDist: 800 },
