...
const DEFAULT_MECHANICS_LIB = {
    ...
    "survival_dome": { label: "Domo de Supervivencia (Survival Dome)", icon: "🔮", desc: "Carga un ataque masivo creando un domo seguro en una ubicacion aleatoria.", fields: ["fireRange", "safeRadius", "maxOffset", "castTimeMs", "cooldown", "damage", "postCastWaitMs", "applyBleed", "bleedDurationMs", "applyStun", "stunDurationMs", "applyPoison", "poisonDurationMs", "startDelay"] }
};
