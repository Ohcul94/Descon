...
const DEFAULT_MECHANICS_LIB = {
    ...
    "melee_slash": { label: "Hachazo Melee 🪓", icon: "🪓", desc: "Corte cuerpo a cuerpo instantáneo: el enemigo levanta el hacha (anticipación) y pega en el área en forma de arco o giro 360°. Pega directo, no carga un área.", fields: ["bulletDamage", "fireRange", "cooldown", "startDelay", "castTimeMs", "arcAngle", "fullCircle", "pushForce", "debuffsList"] }
};
