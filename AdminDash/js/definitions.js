...
const DEFAULT_DEFENSE_LIB = {
    ...
    "duplicado": { label: "Duplicación Defensiva", icon: "👥", desc: "El enemigo se divide en clones que persiguen al jugador y explotan curando al original.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cloneCount", "cloneHp", "cloneShield", "cloneSpeed", "cloneDuration", "cloneExplosionDamage", "cloneHealAmount", "cloneExplodeOnExpiry", "spawnRadius", "cooldown"] }
};
