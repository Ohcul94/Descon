...
const DEFAULT_MECHANICS_LIB = {
    "laser": { label: "Láser Estándar", icon: "🔫", desc: "Ataque lineal básico.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "bulletSpeed", "fireRange", "fireRate", "burstShots", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "missile": { label: "Misil Rastreador", icon: "🚀", desc: "Proyectil autoguiado.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "bulletSpeed", "fireRange", "fireRate", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1500 },
    "ice_missile": { label: "Misil de Hielo", icon: "❄️", desc: "Ralentiza al objetivo.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "bulletSpeed", "fireRange", "fireRate", "slowAmount", "slowDuration", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1500 },
    "mine": { label: "Mina de Proximidad", icon: "💣", desc: "Explosivo estático.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "bulletSpeed", "fireRange", "fireRate", "explosionRadius", "lifetimeMs", "deceleration", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "orbital_strike": { label: "Ataque Orbital", icon: "🌀", desc: "Círculos que giran y luego se disparan.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "bulletSpeed", "orbitSpeed", "circleCount", "orbitRadius", "orbitDuration", "staticTime", "fireRate", "fireRange", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1400 },
    "aura_damage": { label: "Aura de Vacío (Daño)", icon: "🔥", desc: "Daña a los jugadores cercanos continuamente.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "radius", "damage", "intervalMs", "duration", "cooldown", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "hook": { label: "Gancho Abisal", icon: "⚓", desc: "Atrae al objetivo, lo daña y lo paraliza.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "bulletSpeed", "fireRange", "fireRate", "stunDuration", "pullSpeed", "postHookWaitMs", "hookMissWaitMs", "isHoming", "turnSpeed", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "cone_cast": { label: "Ataque en Cono Casteable", icon: "📐", desc: "Ataque en cono que se carga y al completarse daña/stunea.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cooldown", "castTimeMs", "castInterruptible", "damage", "stunDuration", "castSpeed", "coneAngle", "fireRange", "coneFollow", "lockTimeMs", "aimDelayMs", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "bomb": { label: "Lanzador de Bombas", icon: "💣", desc: "Lanza bombas en círculo que explotan tras un retardo.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "bulletDamage", "radius", "fireRange", "bulletSpeed", "bombCount", "bombDelayMs", "fuseTimeMs", "cooldown", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "circle_cast": { label: "Explosión Circular", icon: "⭕", desc: "Ataque circular que se carga siguiendo al enemigo y explota dañando a todos.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cooldown", "castTimeMs", "castInterruptible", "damage", "fireRange", "lockTimeMs", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1200 },
    "sleep": { label: "Sueño Inducido (Sleep)", icon: "💤", desc: "Duerme a los pilotos con somnolencia progresiva y un efecto de pesadilla al despertar.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "fireRange", "targetCount", "targetMode", "targetSphereColor", "duration", "slowPercentage", "slowDuration", "damagePerSecond", "nightmareMultiplier", "wakeOnDamage", "cooldown", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "reflect": { label: "Escudo Reflectante (Reflect)", icon: "🛡️", desc: "Devuelve daño recibido al atacante.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cooldown", "duration", "reflect_mult", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 800 },
    "spin_ring": { label: "Giro de Lillia (spin_ring)", icon: "🌀", desc: "Un orbe gira alrededor del enemigo. Si golpea a un jugador, le inflige daño, le da velocidad al dueño y puede aplicar slow.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cooldown", "radius", "damage", "spinSpeed", "speedBuffAmount", "speedBuffDuration", "applySlow", "slowIsPercentage", "slowPercentage", "slowDuration", "duration", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    ...
    "survival_dome": { label: "Domo de Supervivencia (Survival Dome)", icon: "🔮", desc: "Carga un ataque masivo creando un domo seguro en una ubicacion aleatoria.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "fireRange", "safeRadius", "maxOffset", "castTimeMs", "castInterruptible", "cooldown", "damage", "postCastWaitMs", "startDelay", "debuffsList"], sound: "", soundVolumePercent: 50, soundMaxDist: 1500 },
    "ice_storm": { label: "Tormenta de Hielo", icon: "❄️", desc: "Invoca una tormenta de hielo persistente que daña y ralentiza a los jugadores en el área.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cooldown", "castTimeMs", "castInterruptible", "fireRange", "radius", "lockTimeMs", "duration", "tick_interval", "damage_per_tick", "slow_amount", "slowIsPercentage", "slowDuration", "startDelay"], sound: "", soundVolumePercent: 50, soundMaxDist: 1400 },
...
const DEFAULT_DEFENSE_LIB = {
    ...
    "boss_pillars": { label: "Pilares del Boss", icon: "🗼", desc: "Invoca pilares que lo protegen y curan hasta ser destruidos.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "pillarCount", "pillarType", "pillarHp", "pillarShield", "pillarName", "spawnRadius", "duration", "healIntervalMs", "healPercentPerTick", "healPercentPerPillarOnExpiry", "cooldown", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "boss_colors": { label: "Mecánica de Colores", icon: "🎨", desc: "El Boss y los jugadores cercanos reciben colores. Solo los del color del Boss pueden dañarlo.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "duration", "cooldown", "radius", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "boss_water_orbs": { label: "Orbes de Agua", icon: "💧", desc: "Invoca orbes que viajan al boss. Interceptarlas hace daño pero evita que el boss se cure.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "orbCount", "spawnRadius", "orbSpeed", "playerDamage", "bossHealPercent", "duration", "cooldown", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "duplicado": { label: "Duplicación Defensiva", icon: "👥", desc: "El enemigo se divide en clones que persiguen al jugador y explotan curando al original.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cloneCount", "cloneSpeed", "cloneDuration", "cloneExplodeOnExpiry", "spawnRadius", "cooldown", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
    "wall_dome": { label: "Muro de Energía (Wall Dome)", icon: "🌐", desc: "Crea una cúpula protectora que bloquea proyectiles del exterior.", fields: ["activationMode", "activationHPs", "activationIntervalMs", "cooldown", "duration", "radius", "startDelay", "castTimeMs", "castInterruptible"], sound: "", soundVolumePercent: 50, soundMaxDist: 1000 },
